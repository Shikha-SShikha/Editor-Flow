# Review flow — My Tasks → Integrity Checks → Editorial Assessment — design reference
...
- `Flow.dc.html` — the artboard (a Design Component: an `<x-dc>`
...
Serve the folder (e.g. `python3 -m http.server`) and open `Flow.dc.html`;
